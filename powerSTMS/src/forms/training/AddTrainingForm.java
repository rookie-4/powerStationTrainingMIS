...
public class AddTrainingForm extends JDialog implements ActionListener{
	...
	public AddTrainingForm() {
		...
		CommUtil.setDialogLoaction(this);
...
//			}
//		});
		cmbYear.setModel(new DefaultComboBoxModel(new String[] {"2021", "2022", "2023"}));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(validateEmployee()) {
			...
			boolean saveSuccessful = training.saveTraining(trainingDTO);
